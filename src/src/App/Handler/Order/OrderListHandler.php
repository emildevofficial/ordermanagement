...
if ($orderCount > 0) {
    foreach ($orders as $order) {
        ...
        <tr class='hover:bg-slate-50 dark:hover:bg-slate-700/50 transition'>
            ...
            <td class='px-6 py-4 text-slate-700 dark:text-slate-300 font-medium'>#" . (int)$order['id'] . "</td>

            <td class='px-6 py-4 text-slate-600 dark:text-slate-400'>" . htmlspecialchars($createdDate) . "</td>

            <td class='px-6 py-4 text-slate-600 dark:text-slate-400'>User</td>

            <td class='px-6 py-4 text-slate-600 dark:text-slate-400'>\$0.00</td>

            <td class='px-6 py-4'>
                <span class='px-3 py-1 text-xs font-medium bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300 rounded-full'>
                    Pending
                </span>
            </td>
            ...
            <td class='px-6 py-4 text-slate-600 dark:text-slate-400'>0</td>

            <td class='px-6 py-4'>
                <span class='px-3 py-1 text-xs font-medium " . htmlspecialchars($statusClass) . " rounded-full'>
            ...
            <td class='px-6 py-4 flex gap-2'>
                ...
                <form method='POST' action='/orders/" . (int)$order['id'] . "/update'>
...
<div class='flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-xl transition cursor-pointer'>                    <svg class='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'/></svg>
                    <span class='flex-1'>Orders</span>
                    <span class='ml-auto bg-indigo-100 dark:bg-indigo-800 text-indigo-700 dark:text-indigo-200 text-xs font-semibold px-2 py-0.5 rounded-full'>" . (string)$orderCount . "</span>
                </div>
            </a>
                ...
                <div class='relative' id='profileDropdownToggle'>
                    ...
                    <label for='profileCheckbox' class='flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-700 cursor-pointer'>
                        ...
                        <div class='text-left hidden sm:block'>
                            <p class='text-sm font-medium text-slate-800 dark:text-white'>" . htmlspecialchars($userName ?? 'User') . "</p>
                            <p class='text-xs text-slate-500 dark:text-slate-400 capitalize'>" . htmlspecialchars($role ?? 'user') . "</p>
                        </div>
        ...
        <main class='p-8'>
            ...
            <div class='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6'>
                <div class='bg-white dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 shadow-sm'>
                    ...
                    <p class='text-2xl font-bold text-slate-800 dark:text-white mt-1'>" . (string)$orderCount . "</p>
            ...
            <div class='flex items-center justify-between mt-6'>
                <p class='text-sm text-slate-500 dark:text-slate-400'>
                    Showing <span class='font-medium text-slate-800 dark:text-white'>1-" . (string)$orderCount . "</span> of <span class='font-medium text-slate-800 dark:text-white'>" . (string)$orderCount . "</span> orders
                </p>
