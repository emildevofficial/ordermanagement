    ...
    <div class='flex-1 ml-64 min-h-screen'>
        ...
        <header class='h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-8 sticky top-0 z-20'>
            ...
            <div class='flex items-center gap-4'>
                ...
                <button id='darkToggle' type='button' class='p-2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition' aria-label='Toggle dark mode' aria-pressed='false'>
